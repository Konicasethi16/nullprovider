...
resource "null_resource" "example6" {
  provisioner "local-exec" {
    command = "echo This command will execute whenever the configuration changes-6"
  }
}
resource "null_resource" "example7" {
  provisioner "local-exec" {
    command = "echo This command will execute whenever the configuration changes-7"
  }
}
